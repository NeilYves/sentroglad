            ...
            <table class="table table-hover"> <!-- Hover effect for table rows -->
                ...
                <tbody>
                    ...
                    <?php else: // If no certificates are found (or none match search) ?>
                        <tr><td colspan="6" class="text-center">No certificates found<?php echo !empty($search_query_display) ? ' matching your search' : ''; ?>.</td></tr>
                    <?php endif; ?>
                </tbody>
            </table>
        </div>
...
<script>
// UI enhancement and interaction handlers
document.addEventListener('DOMContentLoaded', function() {
    // Search functionality enhancement
    var searchInput = document.querySelector('input[name="search"]');
    if (searchInput) {
        searchInput.addEventListener('input', function() {
            // Auto-suggest functionality could be added here in the future
        });
    }
...
setTimeout(enhanceTableDisplay, 100);
</script>
