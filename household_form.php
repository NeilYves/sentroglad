...
// Escape function (if not defined)
...
?>
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom"> <h1 class="dashboard-title"><?php echo html_escape($page_title); ?></h1> <div class="btn-toolbar mb-2 mb-md-0"> <a href="manage_households.php" class="btn btn-outline-secondary"> <i class="fas fa-arrow-left me-2"></i>Back to Households List </a> </div> </div>
<!-- Household Form Card -->
<div class="card">
