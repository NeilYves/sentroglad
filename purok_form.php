                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-9">
                            <?php if ($form_action == 'edit'): ?>
                                ...
                                <input type="text" class="form-control" id="purok_name_display"
                                       value="<?php echo html_escape($purok_name); ?>" readonly>
                                <!-- Hidden field to maintain the original name -->
                                <input type="hidden" name="purok_name" value="<?php echo html_escape($purok_name); ?>">
                                <small class="form-text text-muted">
                                    <i class="fas fa-lock me-1"></i>Purok name cannot be changed after creation
                                </small>
                            <?php else: ?>
                                <!-- Editable field for adding new purok -->
