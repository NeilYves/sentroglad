                ...
                <div class="col-sm-9">
                    <select class="form-select" id="position" name="position" required>
                        ...
                        <optgroup label="Council Members">
                            ...
                            <option value="Barangay Kagawad - Committee on Peace and Order" <?php if ($position == 'Barangay Kagawad - Committee on Peace and Order') echo 'selected'; ?>>Barangay Kagawad - Committee on Committee on Peace and Order</option>
                            <option value="Barangay Kagawad - Committee on Health " <?php if ($position == 'Barangay Kagawad - Committee on Health ') echo 'selected'; ?>>Barangay Kagawad - Committee on Health </option>
                            <option value="Barangay Kagawad - Committee on Education" <?php if ($position == 'Barangay Kagawad - Committee on Education') echo 'selected'; ?>>Barangay Kagawad - Committee on Education</option>
                            <option value="Barangay Kagawad - Committee on Agriculture" <?php if ($position == 'Barangay Kagawad - Committee on Agriculture') echo 'selected'; ?>> Barangay Kagawad - Committee on Agriculture</option>
                            <option value="Barangay Kagawad - Committee on Infrastructure" <?php if ($position == 'Barangay Kagawad - Committee on Infrastructure') echo 'selected'; ?>>Barangay Kagawad - Committee on Infrastructure</option>
                            
                            <option value="Barangay Kagawad - Committee on Environment" <?php if ($position == 'Barangay Kagawad - Committee on Environment') echo 'selected'; ?>>Barangay Kagawad - Committee on Environment</option>
                            <option value="Barangay Kagawad - Committee on Appropriation'" <?php if ($position == 'Barangay Kagawad - Committee on Appropriation') echo 'selected'; ?>>Barangay Kagawad - Committee on Appropriation</option>
                        </optgroup>
                    ...
                    <div class="alert alert-info mt-2" style="font-size: 0.9em;">
                        ...
                        <strong>Position Limits & Automatic Transitions:</strong><br>
                        • ALL positions can only have one active official at a time.<br>
                        • When you add someone to any position, any existing official with the same position will automatically be moved to "Ex-" status.<br>
                        • This applies to all positions including Barangay Captain, Secretary, Treasurer, Kagawads, and all committee positions.<br>
                        • You can also manually assign "Ex-" positions from the "Former Officials" section if needed.<br>
                        • This ensures clear succession and prevents multiple people holding the same active position.
                    </div>
                </div>
            </div>
